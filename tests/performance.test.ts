...
(	'Performance comparison',
	...
	{	const decoder = new TextDecoder;
		...
		function persec(since: number, n_iters: number)
		{	return fmt.format(Math.round(n_iters / (Date.now()-since) * 1000));
		}

	for (let [sample_max_length, n_iters] of [[16, 100_000], [100, 80_000], [1000, 10_000], [10_000, 5000]])
		{	let data = [];
			let data_str = [];
			...
			console.log(`%cbtoa sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			...
			console.log(`%cencode64(string) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cencode64(Uint8Array) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cencode64ToBytes(string) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cencode64ToBytes(Uint8Array) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%catob sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cdecode64ToString(string) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cdecode64ToString(Uint8Array) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cdecode64(string) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
			...
			console.log(`%cdecode64(Uint8Array) sample size ${sample_max_length}:%c ${persec(since, n_iters)} ops/sec`, 'color:orange', 'color:inherit');
			for (let i=0; i<n_iters; i++)
